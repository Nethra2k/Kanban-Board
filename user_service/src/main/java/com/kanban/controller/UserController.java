...
//            throw new UserAlreadyExistException();
    ...
    @DeleteMapping("deleteProject/{projectId}/{emailId}")
    public ResponseEntity<?> deleteProject(@PathVariable int projectId,@PathVariable String emailId){
        return new ResponseEntity<>(userService.deleteProject(emailId,projectId),HttpStatus.OK);
    }
}
